...
if __name__ == '__main__':
    ...
    model = LWNet(channel=(8, 16, 32)) # kernel_size/padding = 5/2 7/3 9/4
    checkpoint = torch.load("/data6/lailihao/projects/ICPR-Track2-LightWeight_NpuBugFree/result_WS/LWNet3-1024-300epochs/model_weight.pth.tar")
